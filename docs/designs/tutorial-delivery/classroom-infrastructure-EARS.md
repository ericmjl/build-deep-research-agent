...
- [ ] **TUT-INFRA-001**: The default tutorial LLM path shall use a Modal-hosted open-source model via `TUTORIAL_LLM_BASE_URL`. *(Env var support in `llm.py`; Modal endpoint wiring pending.)*
