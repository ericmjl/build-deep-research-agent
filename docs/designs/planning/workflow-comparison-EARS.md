...
- [x] **PLAN-COMP-020**: Both workflows shall produce a final answer for the same input query under normal classroom conditions.

## Testing

- [x] **PLAN-COMP-030**: Workflow tests with mocked dependencies shall verify both workflow types return a non-empty final answer for a fixed query.
